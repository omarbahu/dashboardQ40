...
WHERE NOT ( CTE.batch is null );
        ...
        .Replace("@batch", $"'{batch}'");
            ...
            catch (SqlException ex)
            {
                throw new InvalidOperationException(
                    $"Error BD en GetBackwardTraceability. company={company}, batch={batch},  connectionString={connectionString}.",
                    ex);
            }
        }
        ...
        public static BatchInfo GetBatchInfoByText(string searchText, string connectionString, string company)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Error BD en GetBatchInfoByText. company={company}, searchText={searchText},  connectionString={connectionString}.",
                    ex);
            }
        }
        ...
        public static DataTable GetChecklistByDateRangeAndReference(DataTable trazabilidad, string company, string connectionString)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Error BD en GetBatchInfoByText. company={company}, trazabilidad={trazabilidad},  connectionString={connectionString}.",
                    ex);
            }
        }
        ...
        public static DataTable GetChecklistByTraceability(DataTable trazabilidad, string company, string connectionString)
        {
            ...
            {
                throw new InvalidOperationException(
                    $"Error BD en GetChecklistByTraceability. company={company}, trazabilidad={trazabilidad},  connectionString={connectionString}.",
                    ex);
            }
        }
...
WHERE NOT ( CTE.batch is null );
        ...
        .Replace("@batch", $"'{batch}'");
            ...
            {
                throw new InvalidOperationException(
                    $"Error BD en GetTraceabilityAudit. company={company}, batch={batch},  connectionString={connectionString}.",
                    ex);
            }
        }
    ...
    ";
            ...
            {
                throw new InvalidOperationException(
                    $"Error BD en GetBatchbyDates. company={company}, F1={F1}, F2={F2} ,  connectionString={connectionString}.",
                    ex);
            }
        }
        ...
        public static List<TrazabilidadNode> ConvertirDataTableATrazabilidad(DataTable dt)
        {
            if (dt == null || dt.Rows.Count == 0)
                return new List<TrazabilidadNode>();
